...
# * https://github.com/samwhelp/note-about-openbox/blob/gh-pages/_demo/project/openboxrc-profile/openboxrc-get/remote-install.sh
# * https://github.com/samwhelp/note-about-openbox/blob/gh-pages/_demo/project/openboxrc-profile/openboxrc-get/openboxrc-get
# * https://raw.githubusercontent.com/samwhelp/note-about-openbox/gh-pages/_demo/project/openboxrc-profile/openboxrc-get/openboxrc-get
...
## $ export DEBUG_OPENBOXRC_GET_INSTALL=true
is_debug () {
	if [ "$DEBUG_OPENBOXRC_GET_INSTALL" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME="openboxrc-get-install"
	fi
	...
	## Target
	## https://github.com/samwhelp/note-about-openbox/blob/gh-pages/_demo/project/openboxrc-profile/openboxrc-get/openboxrc-get
	THE_TARGET_DOWNLOAD_URL='https://raw.githubusercontent.com/samwhelp/note-about-openbox/gh-pages/_demo/project/openboxrc-profile/openboxrc-get/openboxrc-get'


	THE_TARGET_FILE_NAME="openboxrc-get"
